...
android {
    ...
    applicationId = "moe.rukamori.archivetune"
        ...
        // TDLib native packaging: the ~20 MB per-ABI libtdjni.so is NOT
        // bundled — it is downloaded on first use from this repo's GitHub
        // release (digest-pinned, see TdLibNativeLibrary.kt), keeping the
        // APK minimal. Pass -PslimTdlib=false to bundle it locally.
        ...
        buildConfigField(
            ...
            "\"${project.findProperty("tdlibNativeBaseUrl") as String?
                ?: "https://github.com/4nx3B/ArchiveTune/releases/download/tdlib-1.8.56"}\"",
        )
...
dependencies {
    ...
    // TDLib (td-ktx's Telegram API layer + TdApi/Client JNI binding).
    // The td-ktx core (TelegramFlow) is vendored under
    // kotlinx/telegram/core — see its header for why the AAR artifact is
    // not used directly.
