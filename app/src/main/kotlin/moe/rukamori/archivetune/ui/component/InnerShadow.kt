 ...
 *
 * Inner-shadow modifier for the Liquid Glass nav bar's sliding pill. Adapted
 * from Kyant0/AndroidLiquidGlass (Apache 2.0) via SukiSU-Ultra's port —
 * self-contained so we don't depend on a specific kyant `innerShadow` API
 * signature that may differ between versions.
 *
