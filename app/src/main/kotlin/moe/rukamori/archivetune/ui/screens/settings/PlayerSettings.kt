                ...
                item {
                    Column(modifier = positions.modifierFor("download_source")) {
                        EnumListPreference(
                            ...
                            valueText = {
                                when (it) {
                                    AudioSourceType.QOBUZ -> stringResource(R.string.download_source_qobuz)
                                    AudioSourceType.TIDAL -> stringResource(R.string.download_source_tidal)
                                    AudioSourceType.YOUTUBE -> stringResource(R.string.download_source_youtube_music)
                                }
                            },
                        )
                    }
