 ...
 * ## Why this exists
 *
 * the smart-fade driver renders every transition as an equal-power gain blend,
 ...
 *    ([TransitionPlan.bassSwapFraction]).
 ...
 * ## Gliding
 *
 * Cutoffs are targets, not values. the smart-fade driver re-aims them once per
 ...
 * track leaving.
 *
 * An interface rather than the processors themselves so the smart-fade driver
